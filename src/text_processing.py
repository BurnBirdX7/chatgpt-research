...
from .pipeline import BaseNode, BaseDataDescriptor, StrDescriptor, ListDescriptor, DictDescriptor
...
class TextProcessingNode(BaseNode, Generic[T]):
    def __init__(self, name: str, func: Callable[[T], T],
                 in_types: List[type], out_descriptor: BaseDataDescriptor):
